...
const CATS = [
  { cat:"hing",      name:"Hing Powder",      tag:"Pure Asafoetida",  count:"3 products",   emoji:"🫙",  grad:"linear-gradient(150deg,#8B1A2E,#A82438)" },
  { cat:"methi",     name:"Kasoori Methi",    tag:"Dried Fenugreek",  count:"2 products",   emoji:"🌿",  grad:"linear-gradient(150deg,#2A9D8F,#264653)" },
  { cat:"seasoning", name:"Seasoning Blends", tag:"Custom Masalas",   count:"35+ products", emoji:"🌶️", grad:"linear-gradient(150deg,#C8956B,#8B3A2E)" },
];
